...
class AnimationUtils {
    ...
    companion object {
         ...
         */
        fun enterTranslateX(view: View, root: View, delay: Long, translationMultiplier: Float = 1f, duration: Long = 400) {
         ...
         * @param duration duration of the animation
         */
        fun enterTranslateY(view: View, root: View, delay: Long, translationMultiplier: Float = 1f, duration: Long = 400) {
            Handler(Looper.getMainLooper()).postDelayed({
